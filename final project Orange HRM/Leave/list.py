...
class TestEmployeList(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_a_employe_list(self): 
        ...
        time.sleep(3)
        browser.find_element(By.XPATH,"/html/body/div/div[1]/div[1]/aside/nav/div[2]/ul/li[3]/a").click() # klik tombol sign in
        time.sleep(2)
        browser.get("https://opensource-demo.orangehrmlive.com/web/index.php/leave/viewLeaveList") # masuk ke halaman 
        time.sleep(3)
        browser.maximize_window()
        browser.execute_script("window.scrollBy(0,440)","")
        time.sleep(2)
